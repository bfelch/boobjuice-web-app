...
def test_datetime_from_timestamp_invalid():
	...
	dt = date_utils.datetime_from_timestamp(timestamp, '%invalid format')
...
def test_timestamp_from_datetime_invalid():
	dt = datetime(2024, 8, 7, 17, 36)
	timestamp = date_utils.timestamp_from_datetime(dt, '%invalid format')
